...
public class DeactivateAdvertisment 
{
	public static HttpServletRequest sendData (HttpServletRequest request, String adId, String userId) throws Exception
	{
		if (adId == null)
		{
			throw new Exception ("sendData.DeactivateAdvertisment.java: no adId");
		}
		if (userId == null)
		{
			throw new Exception ("sendData.DeactivateAdvertisment.java: noUserId");
		}
		
		Ad ad = DBAdministration.getActivAd(adId);
		ad.setDeactivationDateClear();
